...
// (DO NOT EDIT: machine generated header) 'Vcl.Buttons.pas' rev: 33.00 (Windows)
...
enum DECLSPEC_DENUM Vcl_Buttons__7 : unsigned char { nsAllowTimer };

typedef System::Set<Vcl_Buttons__7, Vcl_Buttons__7::nsAllowTimer, Vcl_Buttons__7::nsAllowTimer> TNavButtonStyle;
...
public:
	/* TSpeedButton.Create */ inline __fastcall virtual TNavButton(System::Classes::TComponent* AOwner) : TSpeedButton(AOwner) { }
